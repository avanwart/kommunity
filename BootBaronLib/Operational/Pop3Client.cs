/*
 * 
 * FROM: sasi prabhu, 28 Apr 2011
 * URL: http://www.codeproject.com/Articles/188349/Read-Gmail-Inbox-Message-in-ASP-NET
 * 
 */
...
namespace BootBaronLib.Operational
{
    ...
    public class Pop3Client : IDisposable
    {
        ...
        {
            SendCommand("DELE " + messageID);

            Quit();// must quit or deletion doesn't occur
        }
