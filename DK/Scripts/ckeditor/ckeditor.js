...
(function() {
    ...
    if (!window.CKEDITOR)
        window.CKEDITOR = (function() {
            var a = {
                timestamp: 'C6HH5UF', version: '3.6.4', revision: '7575', rnd: Math.floor(Math.random() * 900) + 100, _: {}, status: 'unloaded',
                basePath: (function() {
    ...
    (function() {
        ...
        a.htmlParser.fragment.fromHtml = function(q, r, s) {
            ...
            function B() { while (w.length) C(w.shift(), x); }
    ...
    (function() {
        ...
        j.add(m, {
            requires: ['dialog'], availableLangs: { cs: 1, cy: 1, da: 1, de: 1, el: 1, en: 1, eo: 1, fa: 1, fi: 1, fr: 1, gu: 1, he: 1, it: 1, mk: 1, nb: 1, nl: 1, no: 1, 'pt-br': 1, ro: 1, tr: 1, ug: 1, vi: 1, 'zh-cn': 1 },
            init: function(o) {
                var p = this;
                o.addCommand(n, {
                    exec: function() {
    ...
    (function() {
        var m = { ol: 1, ul: 1 }, n = /^[\n\r\t ]*$/, o = d.walker.whitespaces(), p = d.walker.bookmark(), q = function(N) { return !(o(N) || p(N)); }, r = d.walker.bogus();
        ...
        function L(N, O, P) {
            ...
            ae.evaluator = function(ag) { return q(ag) && !r(ag); };
            var af = ae.next();
            ...
            init: function(N) {
                ...
                N.on('key', function(Q) {
                    ...
                    if (N.mode == 'wysiwyg' && R in { 8: 1, 46: 1 }) {
                        ...
                        W.evaluator = function(ah) { return q(ah) && !r(ah); };
                        var X = T.clone();
                        if (U) {
    ...
    (function() {
        var m, n = {
            modes: { wysiwyg: 1, source: 1 }, canUndo: false, readOnly: 1,
            exec: function(p) {
                ...
                if (!t && !b.gecko) {
                    ...
                    C.write(q);
                    C.close();
                    b.webkit && setTimeout(function() { C.body.innerHTML += ''; }, 0);
                }
            }
        }, o = 'preview';
        j.add(o, {
        ...
        j.add('scayt', {
            ...
            init: function(t) {
                ...
                t.ui.add('Scayt', 'menubutton', {
                    label: C.title, title: b.opera ? C.opera_title : C.title, className: 'cke_button_scayt', modes: { wysiwyg: 1 }, onRender: function() { y.on('state', function() { this.setState(y.state); }, this); },
                    onMenu: function() {
    ...
    (function() {
        ...
        var p = {
            preserveState: true, editorFocus: false, readOnly: 1,
            exec: function(q) {
                this.toggleState();
                this.refresh(q);
            },
    ...
    j.add('specialchar', {
        requires: ['dialog'], availableLangs: { cs: 1, cy: 1, de: 1, el: 1, en: 1, eo: 1, et: 1, fa: 1, fi: 1, fr: 1, he: 1, hr: 1, it: 1, nb: 1, nl: 1, no: 1, 'pt-br': 1, tr: 1, ug: 1, 'zh-cn': 1 },
        init: function(m) {
    ...
    (function() {
        var m = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, n = d.walker.whitespaces(true), o = d.walker.bogus(true), p = function(E) { return n(E) && o(E); };
        ...
        function v(E) { if (!E.checkDirty()) setTimeout(function() { E.resetDirty(); }, 0); }
                ...
                E.on('editingBlockReady', function() {
                    ...
                    function W(X) {
                        ...
                        if (c && Y.$.compatMode == 'CSS1Compat') {
                            var af = { 33: 1, 34: 1 };
                            Y.on('keydown', function(ag) { if (ag.data.getKeystroke() in af) setTimeout(function() { E.getSelection().scrollIntoView(); }, 0); });
                        }
                        ...
                        setTimeout(function() {
                            ...
                            if (E.config.disableObjectResizing)
                                try {
                                    ...
                                    E.document.getBody().on(c ? 'resizestart' : 'resize', function(aj) { aj.data.preventDefault(); });
                                }
                            if (c)
                                setTimeout(function() {
                                    if (E.document) {
    ...
    (function() {
        ...
        function n(Q) { return !!this._.tabs[Q][0].$.offsetHeight; }
        ...
        a.dialog = function(Q, R) {
            ...
            this.parts = ab.parts;
            e.setTimeout(function() { Q.fire('ariaWidget', this.parts.contents); }, 0, this);
            ...
            if (S.onOk)
                this.on('ok', function(aq) {
                    Q.fire('saveSnapshot');
                    setTimeout(function() { Q.fire('saveSnapshot'); }, 0);
        ...
        function t(Q, R, S) {
            ...
            this.focusIndex = S;
            this.tabIndex = 0;
            this.isFocusable = function() { return !R.getAttribute('disabled') && R.isVisible(); };
            this.focus = function() {
                Q._.currentFocusIndex = this.focusIndex;
                this.element.focus();
            };
            R.on('keydown', function(T) { if (T.data.getKeystroke() in { 32: 1, 13: 1 }) this.fire('click'); });
            R.on('focus', function() { this.fire('mouseover'); });
            R.on('blur', function() { this.fire('mouseout'); });
        }
        ...
        a.dialog.prototype = {
            ...
            show: function() {
                ...
                if (b.gecko && b.version < 10900) {
                    ...
                    setTimeout(function() { S.setStyle('position', 'fixed'); }, 0);
                }
                ...
                e.setTimeout(function() {
                    ...
                    this.foreach(function(U) { U.setInitValue && U.setInitValue(); });
                }, 100, this);
            },
            layout: function() {
                var S = this;
            ...
            reset: (function() {
                var Q = function(R) { if (R.reset) R.reset(1); };
                return function() {
                    this.foreach(Q);
                    return this;
                };
            ...
            setupContent: function() {
                var Q = arguments;
                this.foreach(function(R) { if (R.setup) R.setup.apply(R, Q); });
            },
            ...
            getValueOf: function(Q, R) { return this.getContentElement(Q, R).getValue(); },
            setValueOf: function(Q, R, S) { return this.getContentElement(Q, R).setValue(S); },
            getButton: function(Q) { return this._.buttons[Q]; },
            click: function(Q) { return this._.buttons[Q].click(); },
            disableButton: function(Q) { return this._.buttons[Q].disable(); },
            enableButton: function(Q) { return this._.buttons[Q].enable(); },
        ...
        e.extend(a.dialog, {
            add: function(Q, R) { if (!this._.dialogDefinitions[Q] || typeof R == 'function') this._.dialogDefinitions[Q] = R; },
            exists: function(Q) { return !!this._.dialogDefinitions[Q]; },
            getCurrent: function() { return a.dialog._.currentTop; },
            okButton: (function() {
                var Q = function(R, S) {
                    S = S || {};
                    return e.extend({
                        id: 'ok', type: 'button', label: R.lang.common.ok, 'class': 'cke_dialog_ui_button_ok',
                        onClick: function(T) {
                            var U = T.data.dialog;
                ...
                Q.type = 'button';
                Q.override = function(R) { return e.extend(function(S) { return Q(S, R); }, { type: 'button' }, true); };
                return Q;
            })(),
            ...
            addUIElement: function(Q, R) { this._.uiElementBuilders[Q] = R; }
        });
        ...
        y.prototype = { getContents: function(Q) { return v(this.contents, Q); }, getButton: function(Q) { return v(this.buttons, Q); }, addContents: function(Q, R) { return w(this.contents, Q, R); }, addButton: function(Q, R) { return w(this.buttons, Q, R); }, removeContents: function(Q) { x(this.contents, Q); }, removeButton: function(Q) { x(this.buttons, Q); } };
        ...
        ;
        z.prototype = { get: function(Q) { return v(this.elements, Q, 'children'); }, add: function(Q, R) { return w(this.elements, Q, R, 'children'); }, remove: function(Q) { x(this.elements, Q, 'children'); } };
        ...
        function B(Q) {
            ...
            T.on('destroy', function() { e.removeFunction(aa); });
        ...
        function F(Q) { Q.data.preventDefault(1); }
        ...
        (function() {
            k.dialog = {
                uiElement: function(Q, R, S, T, U, V, W) {
                    ...
                    if (typeof R.isChanged == 'boolean') this.isChanged = function() { return R.isChanged; };
                    if (typeof R.isChanged == 'function') this.isChanged = R.isChanged;
                    if (typeof R.setValue == 'function') this.setValue = e.override(this.setValue, function(al) { return function(am) { al.call(this, R.setValue.call(this, am)); }; });
                    if (typeof R.getValue == 'function') this.getValue = e.override(this.getValue, function(al) { return function() { return R.getValue.call(this, al.call(this)); }; });
                    ...
                    if (this.keyboardFocusable) {
                        ...
                        this.on('focus', function() { Q._.currentFocusIndex = ak.focusIndex; });
                    }
                    e.extend(this, R);
                },
        ...
        k.dialog.uiElement.prototype = {
            ...
            registerEvents: function(Q) {
                var R = /^on([A-Z]\w+)/, S, T = function(V, W, X, Y) { W.on('load', function() { V.getInputElement().on(X, Y, V); }); };
                for (var U in Q) {
            ...
            eventProcessors: { onLoad: function(Q, R) { Q.on('load', R, this); }, onShow: function(Q, R) { Q.on('show', R, this); }, onHide: function(Q, R) { Q.on('hide', R, this); } },
            accessKeyDown: function(Q, R) { this.focus(); },
        ...
        a.dialogCommand = function(Q) { this.dialogName = Q; };
        a.dialogCommand.prototype = { exec: function(Q) { b.opera ? e.setTimeout(function() { Q.openDialog(this.dialogName); }, 0, this) : Q.openDialog(this.dialogName); }, canUndo: false, editorFocus: c || b.webkit };
        (function() {
            ...
            a.dialog.validate = {
                ...
                integer: function(W) { return this.regex(R, W); },
                number: function(W) { return this.regex(S, W); },
                cssLength: function(W) { return this.functions(function(X) { return U.test(e.trim(X)); }, W); },
                htmlLength: function(W) { return this.functions(function(X) { return T.test(e.trim(X)); }, W); },
                inlineStyle: function(W) { return this.functions(function(X) { return V.test(e.trim(X)); }, W); },
                equals: function(W, X) { return this.functions(function(Y) { return Y == W; }, X); },
                notEqual: function(W, X) { return this.functions(function(Y) { return Y != W; }, X); }
            };
    ...
    (function() {
        ...
        a.style.prototype = {
            apply: function(T) { S.call(this, T, false); }, remove: function(T) { S.call(this, T, true); },
    ...
    (function() {
        ...
        function r(z) {
            ...
            function A(E) { return E && E.type == 1 && E.getName() in f.$removeEmpty; }
        ...
        d.selection.prototype = {
            ...
            getRanges: (function() {
                var z = c ? (function() {
                    ...
                    function A(C) { return new d.node(C).getIndex(); }
